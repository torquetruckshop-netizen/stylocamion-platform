const fallbackNews = [
  { title: 'Salud y seguridad para quienes viven en la ruta', summary: 'Descanso, sedentarismo, alimentación, estrés, sobrepeso y prevención para conducir y trabajar mejor.', category: 'Ruta, salud y seguridad', source: 'Stylo Camión', url: '#ultimas', time: 'Radar editorial' },
  { title: 'Camiones y mercado: ventas, crédito y lanzamientos', summary: 'Patentamientos, financiación, camiones chinos, modelos más vendidos y novedades disponibles en Argentina.', category: 'Camiones y mercado', source: 'Stylo Camión', url: '#ultimas', time: 'Radar editorial' },
  { title: 'Logística argentina: puertos, última milla y Vaca Muerta', summary: 'Operación, corredores, puntos de descarga y movimientos que explican la demanda de transporte.', category: 'Logística y puertos', source: 'ARLOG', url: 'https://arlog.org/', time: 'Fuente sectorial' },
  { title: 'Técnica y equipos: neumáticos, repuestos y remolques', summary: 'Tecnología, mantenimiento, componentes, implementos y soluciones para mejorar la operación.', category: 'Técnica y equipos', source: 'Stylo Camión', url: '#ultimas', time: 'Radar editorial' },
  { title: 'Economía del transporte: costos, combustible y financiación', summary: 'Índice FADEEAC, tasas, crédito, combustible y variables para decidir sobre flota y operación.', category: 'Economía y costos', source: 'FADEEAC', url: 'https://www.fadeeac.org.ar/', time: 'Fuente sectorial' },
  { title: 'La región: fronteras, corredores y actividad', summary: 'Noticias de Sudamérica que afectan cargas, logística y movimiento de camiones.', category: 'Región', source: 'Stylo Camión', url: '#ultimas', time: 'Seguimiento permanente' }
];
...
const translations = {
  es: {
    ...
    routeLabel:'MODO RUTA · BOLETÍN AUTOMÁTICO', routeTitle:'Escuchá las noticias importantes del día, una detrás de otra.', routeText:'Un resumen continuo de salud y seguridad, camiones, mercado, logística, puertos, técnica y economía. Preparado para iniciar antes de salir y escuchar con el teléfono conectado al vehículo.', routeButton:'▶ Escuchar Boletín de Ruta', routeSafety:'Activá la reproducción antes de iniciar la marcha o mediante controles manos libres.',
  ...
  pt: {
    ...
    routeLabel:'MODO ESTRADA · BOLETIM AUTOMÁTICO', routeTitle:'Ouça as notícias mais importantes do dia, uma após a outra.', routeText:'Resumo contínuo de saúde e segurança, caminhões, mercado, logística, portos, técnica e economia, pensado para ouvir com o telefone conectado ao veículo.', routeButton:'▶ Ouvir Boletim de Estrada', routeSafety:'Inicie a reprodução antes de dirigir ou use controles mãos livres.',
