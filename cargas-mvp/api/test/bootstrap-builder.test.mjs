...
test('bootstrap instala economía telemetría marketplace y operational intelligence en orden', () => {
  ...
  const operational=sql.indexOf('-- ===== 014_operational_intelligence.sql =====');
  assert.ok(economics>=0 && telematics>economics && profiles>telematics && marketplace>profiles && operational>marketplace);
