...
test('staging base puede quedar listo aunque WhatsApp/OpenAI aún no estén conectados',()=>{
  const env={SUPABASE_URL:'https://example.supabase.co',SUPABASE_SERVICE_ROLE_KEY:'secret',GOOGLE_CLIENT_ID:'client',ADMIN_API_KEY:'admin'};
