...
const facts=[
 {module:'CARGAS',event_type:'LOAD_DETECTED',entity_type:'LOAD',entity_id:'L1',occurred_at:'2026-08-15T10:00:00Z'},
...
test('comparación diaria calcula variación contra período anterior',()=>{
